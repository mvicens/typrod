...
function config($tpdProvider) {
	...
	$tpdProvider
		.component('form', '<div class="row mb-3" tpd-property><label class="col-sm-2 col-form-label" ng-attr-for="' + ATTR + '" tpd-label></label><div class="col-sm-10"><tpd-input ng-attr-id="' + ATTR + '" /></div></div><button type="submit" class="btn btn-primary">Filter</button>', {
		...
		.component('tbody > tr', '<td tpd-property>' + HTML + '</td><td><button type="button" class="btn" ng-class="\'btn-\'+(values.$$isEditing?\'primary\':\'secondary\')" ng-click="vm.toggleEdit(values)">{{values.$$isEditing?\'Save\':\'Edit\'}}</button></td>', {
